...
| **discussion_url** | https://lore.kernel.org/netdev/20260112181626.20117-1-viswanathiyyappan@gmail.com/ |
...
This mechanism also prevents rx mode set requests from building up as only the most recent rx mode set request will be confirmed.
